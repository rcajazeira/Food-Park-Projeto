...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,500&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;1,100;1,300;1,500;1,700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="barra_menu.css" />
  ...
  <body>
   ...
   <div class="lateral">
        <div class="column">
                <div class="row">
                    <div class="box">
                      <img src="/cadastro_0/images/product-hunt.svg" alt="">
                        <a href="#">Produto</a>
                    </div>
                    <div class="box">
                      <img src="/cadastro_0/images/truck-fast-solid2.svg" alt="">
                        <a href="#">Truck</a>
                    </div>
                    <div class="box">
                      <img src="/cadastro_0/images/money-bill-trend-up-solid.svg" alt="">
                        <a href="#">Promoção</a>
                    </div>
                    <div class="box">
                      <img src="/cadastro_0/images/user-tie-solid.svg" alt="">
